/**
 * Name        : com.malcolm.daotest.mybatis.MyBatisModelMapper.java
 * Author      : Malcolm
 * Created on  : Jun 10, 2014
 *
 * Description : Model Mapper for MyBatis Model to BDO Object 
 */
...
/**
 * Model Mapper for MyBatis Model to BDO Object
 * 
 * @author Malcolm
 */
public class MyBatisModelMapper {
	/**
	 * Model Mapper
	 */
	...
	private static EmployeeBDO mapEmployeeRolesInfo(EmployeeBDO employeeBDO, Employee employee) {
		...
		List<RoleEmployee> employeeRoleList = employee.getEmployeeRoleAssn();
	...
	private static EmployeeBDO mapEmployeeProjectsInfo(EmployeeBDO employeeBDO, Employee employee) {
		...
		List<ProjectEmployee>	employeeProjectList 	= employee.getEmployeeProjectAssn();
