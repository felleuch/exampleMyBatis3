/**
 * Name        : com.malcolm.daotest.mybatis.dao.EmployeeDAOMyBatisSpringTest.java
 * Author      : Malcolm
 * Created on  : May 23, 2014
 *
 * Description : MyBatis DAO Test 
 */
...
public class EmployeeDAOMyBatisSpringTest {
	 ...
	 */
	private static final String htmlReportPath = "EmployeeDAOMyBatisSpringTest.html";
	...
	public static void getReport() throws IOException {
		...
		if(reportPath != null){
			...
			content.add("<HTML><HEAD><TITLE>EmployeeDAOMyBatisSpringTest</TITLE></HEAD><BODY>");
	...
	private void validateEmployeeList(List<Employee> employeeList) {
		for (Employee employee : employeeList) {
			...
			if(employee.getEmployeeProjectAssn() != null ){
				List<ProjectEmployee> projectAssnList = employee.getEmployeeProjectAssn();
			...
			if(employee.getEmployeeRoleAssn() != null ){
				List<RoleEmployee> roleAssnList = employee.getEmployeeRoleAssn();
