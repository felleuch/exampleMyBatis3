...
@Transactional
public class EmployeeServiceHibernatePerfMetricsSpringTest {
	/**
	 ...
	 */
	private static final String htmlReportPath = "/temp/EmployeeServiceHibernatePerfMetricsSpringTest.html";
	
	@AfterClass
	public static void getReport() throws IOException {
		Path file = Paths.get(htmlReportPath);
		List<String> content = new ArrayList<String>(); 
		content.add("<HTML><HEAD><TITLE>EmployeeServiceHibernatePerfMetricsSpringTest</TITLE></HEAD><BODY>");
