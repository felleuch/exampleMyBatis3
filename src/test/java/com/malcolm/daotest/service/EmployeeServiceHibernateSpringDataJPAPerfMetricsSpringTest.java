...
@Transactional
public class EmployeeServiceHibernateSpringDataJPAPerfMetricsSpringTest {
	/**
	 ...
	 */
	private static final String htmlReportPath = "/temp/EmployeeServiceHibernateSpringDataJPAPerfMetricsSpringTest.html";
	
	@AfterClass
	public static void getReport() throws IOException {
		Path file = Paths.get(htmlReportPath);
		List<String> content = new ArrayList<String>(); 
		content.add("<HTML><HEAD><TITLE>EmployeeServiceHibernateSpringDataJPAPerfMetricsSpringTest</TITLE></HEAD><BODY>");
